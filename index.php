        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="index.php?category=display&code=1" class="active"></i> คอมพิวเตอร์</a>
                    </li>
                    <li>
                        <a href="index.php?category=display&code=2" class="active"></i> เมาส์</a>
                    </li>
                    <li>
                        <a href="index.php?category=display&code=3" class="active"></i> คีย์บอร์ด</a>
                    </li>
                </ul>
            </div>
        </div>
